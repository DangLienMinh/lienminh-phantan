...
$active_record = TRUE;
$db['oracle']['username'] = "minh_nh";
$db['oracle']['password'] = "minh_nh";
$db['oracle']['hostname'] = "(DESCRIPTION =(ADDRESS_LIST =(ADDRESS =(PROTOCOL = TCP)(HOST = localhost)(PORT = 1521)))(CONNECT_DATA =(SID = orcl)(SERVER = DEDICATED)))";
