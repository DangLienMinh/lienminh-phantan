...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_548ef7ff6158c5_71758518',
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_548ef7ff6158c5_71758518')) {function content_548ef7ff6158c5_71758518($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
...
<head>
    ...
    <script type="text/javascript" src="http://localhost:81/QLNganHang/assets/js/bootstrap.min.js"></script>
    <script type="text/javascript" src="http://localhost:81/QLNganHang/assets/js/jquery.price_format.2.0.min.js"></script>
    <!-- Bootstrap Core CSS -->
    <link rel="stylesheet" type="text/css" href="http://localhost:81/QLNganHang/assets/css/bootstrap.min.css">
    <link rel="stylesheet" type="text/css" href="http://localhost:81/QLNganHang/assets/css/sb-admin.css">
    <link rel="stylesheet" type="text/css" href="http://localhost:81/QLNganHang/assets/font-awesome-4.1.0/css/font-awesome.min.css">
    <style type="text/css">
        .tab-content {
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    <li class="active">
                        <a href="http://localhost:81/QLNganHang/main/guiTien"><i class="fa fa-fw fa-edit"></i> Nghiệp Vụ</a>
                    </li>
                    <li>
                        <a href="http://localhost:81/QLNganHang/main/khachHang"><i class="fa fa-fw fa-user"></i> QL Khách Hàng</a>
                    </li>
                    <li>
